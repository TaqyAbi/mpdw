...
dwtest(regres)
```
Pada hasil dapat diketahui bahwa terdapat autokorelasi dikarenakan nilai hasil uji DW berada di luar rentang DU \< DW \< 4-DU atau $1.3605 < DW < 2.6395$. Diperkuat juga nilai p-value yang kurang dari 0.05 sehingga menolak H0 yang mana berarti ada autokorelasi.
